...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-100 py-6 sm:py-12 flex flex-col justify-center" style={{ backgroundImage: "url('https://wallpapercave.com/wp/wp5121853.png')", backgroundSize: 'cover' }}>
